...
# define UNABLE_TO_USE_USE_FUNC			"ERROR: Abstract base Member function use can't be use\n"
# define NOT_IN_INDEX_RANGE				"ERROR: Index not in Inventory range\n"
# define NO_SPACE_IN_INVENTORY			"WARNING: No space left in inventory\n";
